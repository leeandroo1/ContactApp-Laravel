            ...
            <form method="POST" action="{{ route('contacts.update', $contact->id) }}">
              ...
              <div class="row mb-3">
                ...
                <div class="col-md-6">
                  ...
                  autofocus value="{{ old('name') ?? $contact->name}}">
                    @error('name')
              ...
              <div class="row mb-3">
                ...
                <div class="col-md-6">
                  <input id="phone_number" type="tel"
                    ...
                    autocomplete="phone_number" value="{{ old('phone_number') ?? $contact->phone_number }}">
                  @error('phone_number')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
              ...
              <div class="row mb-3">
                ...
                <div class="col-md-6">
                  <input id="email" type="text"
                    ...
                    autocomplete="email" value="{{ old('email') ?? $contact->email }}">
                  @error('email')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
              ...
              <div class="row mb-3">
                ...
                <div class="col-md-6">
                  <input id="age" type="text"
                    ...
                    autocomplete="age" value="{{ old('age') ?? $contact->age }}">
                  @error('age')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
